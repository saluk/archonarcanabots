...
var set5artists = ['Adam Vehige', 'Alena Medovnikova', 'Alena Zhukova', 'Alexandre Leoni', 'Alexey Iavtushenco', 'Andrew Bosley', 'Art Tavern', 'BalanceSheet', 'Bogdan Tauciuc', 'Borja Pindado', 'Brandon Hunt', 'Brian Fajardo', 'Brolken', 'Caio Monteiro', 'Caravan Studio', 'Chris Bjors', 'Colin Searle', 'Dany Orizio', 'David Tenorio', 'Dong Cheng', 'Felipe Martini', 'Flaviano Pivoto', 'Fábio Perez', 'Gabriel Rubio', 'Gabriel Scavariello', 'Gabriela Marchioro', 'Girma Moges', 'Gong Studios', 'Grigory Serov', 'Ilya Bondarenko', 'Jason Juta', 'John Silva', 'Josh Corpuz', 'Konstantin Turovec', 'Leandro Franci', 'Lucas Firmino', 'Marc Escachx', 'Mariana Ennes', 'Marko Fiedler', 'Mateusz Mizak', 'Michele Giorgi', 'Mihai Radu', 'Mo Mukhtar', 'Monztre', 'Nasrul Hakim', 'Oscar Römer', 'Quentin de Warren', 'Radial Studio', 'Radial Studios', 'Regis Torres', 'Roman Semenenko', 'Sean Donaldson', 'Stanislav Dikolenko', 'Steve Ellis', 'Timur Shevtsov', 'Tomek Larek', 'Vladimir Kafanov', 'Vladimir Zyrianov', 'Ângelo Bortolini']
...
var set5traits = ['AI', 'Alien', 'Angel', 'Aquan', 'Beast', 'Cyborg', 'Dinosaur', 'Elf', 'Fisher', 'Human', 'Item', 'Knight', 'Law', 'Leader', 'Location', 'Monk', 'Mutant', 'Politician', 'Power', 'Priest', 'Proximan', 'Robot', 'Scientist', 'Ship', 'Soldier', 'Spirit', 'Thief', 'Treasure', 'Weapon', 'Witch']
var cardCombos = []
