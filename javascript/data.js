...
var set5artists = ['Alexandre Leoni', 'Art Tavern', 'BalanceSheet', 'Bogdan Tauciuc', 'Brian Fajardo', 'Brolken', 'Caio Monteiro', 'Chris Bjors', 'David Tenorio', 'Dong Cheng', 'Gabriel Rubio', 'Grigory Serov', 'John Silva', 'Marc Escachx', 'Mariana Ennes', 'Marko Fiedler', 'Michele Giorgi', 'Monztre', 'Radial Studio', 'Radial Studios', 'Roman Semenenko', 'Stanislav Dikolenko', 'Tomek Larek', 'Vladimir Kafanov', 'Vladimir Zyrianov', 'Ângelo Bortolini']
