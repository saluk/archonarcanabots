...
var set5traits = ['AI', 'Alien', 'Angel', 'Aquan', 'Beast', 'Cat', 'Cyborg', 'Dinosaur', 'Dragon', 'Elf', 'Fisher', 'Fungus', 'Handuhan', 'Human', 'Insect', 'Item', 'Knight', 'Krxix', 'Law', 'Leader', 'Location', 'Monk', 'Mutant', 'Pilot', 'Politician', 'Power', 'Priest', 'Proximan', 'Quest', 'Robot', 'Scientist', 'Ship', 'Soldier', 'Specter', 'Spirit', 'Thief', 'Treasure', 'Weapon', 'Witch']
var cardCombos = []
