...
var set5artists = ['Alexandre Leoni', 'Art Tavern', 'BalanceSheet', 'Bogdan Tauciuc', 'Brian Fajardo', 'Brolken', 'Caio Monteiro', 'Chris Bjors', 'David Tenorio', 'Dong Cheng', 'Flaviano Pivoto', 'Gabriel Rubio', 'Gong Studios', 'Grigory Serov', 'John Silva', 'Marc Escachx', 'Mariana Ennes', 'Marko Fiedler', 'Mateusz Mizak', 'Michele Giorgi', 'Monztre', 'Radial Studio', 'Radial Studios', 'Roman Semenenko', 'Stanislav Dikolenko', 'Tomek Larek', 'Vladimir Kafanov', 'Vladimir Zyrianov', 'Ângelo Bortolini']
...
var set5traits = ['AI', 'Alien', 'Angel', 'Aquan', 'Beast', 'Dinosaur', 'Elf', 'Fisher', 'Human', 'Knight', 'Law', 'Mutant', 'Politician', 'Power', 'Robot', 'Scientist', 'Ship', 'Spirit', 'Thief', 'Witch']
var cardCombos = []
