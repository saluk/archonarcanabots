...
var traits = ['AI', 'Agent', 'Alien', 'Ally', 'Angel', 'Aquan', 'Arm', 'Artisan', 'Assassin', 'Beast', 'Blorb', 'Cat', 'Changeling', 'Cyborg', 'Demon', 'Dinosaur', 'Dragon', 'Egg', 'Elf', 'Equation', 'Experiment', 'Faerie', 'Fisher', 'Fungus', 'Getrookya', 'Getrookya•Politician', 'Giant', 'Goblin', 'Handuhan', 'Horseman', 'Human', 'Hunter', 'Imp', 'Insect', 'Item', 'Jelly', 'Knight', 'Krxix', 'Law', 'Leader', 'Location', 'Martian', 'Merchant', 'Monk', 'Mutant', 'Niffle', 'Philosopher', 'Phoenix', 'Pilot', 'Pirate', 'Politician', 'Power', 'Priest', 'Proximan', 'Psion', 'Quest', 'Ranger', 'Rat', 'Rebel', 'Redacted', 'Robot', 'Scientist', 'Shapeshifter', 'Shard', 'Ship', 'Sin', 'Soldier', 'Specter', 'Spirit', 'Thief', 'Treasure', 'Tree', 'Vehicle', 'Weapon', 'Witch', 'Wolf']
