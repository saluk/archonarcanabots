...
var set5artists = ['Alexandre Leoni', 'Art Tavern', 'BalanceSheet', 'Bogdan Tauciuc', 'Brian Fajardo', 'Brolken', 'Caio Monteiro', 'Caravan Studio', 'Chris Bjors', 'Colin Searle', 'David Tenorio', 'Dong Cheng', 'Felipe Martini', 'Flaviano Pivoto', 'Gabriel Rubio', 'Gong Studios', 'Grigory Serov', 'John Silva', 'Konstantin Turovec', 'Leandro Franci', 'Lucas Firmino', 'Marc Escachx', 'Mariana Ennes', 'Marko Fiedler', 'Mateusz Mizak', 'Michele Giorgi', 'Monztre', 'Radial Studio', 'Radial Studios', 'Roman Semenenko', 'Sean Donaldson', 'Stanislav Dikolenko', 'Steve Ellis', 'Tomek Larek', 'Vladimir Kafanov', 'Vladimir Zyrianov', 'Ângelo Bortolini']
...
var set5traits = ['AI', 'Alien', 'Angel', 'Aquan', 'Beast', 'Cyborg', 'Dinosaur', 'Elf', 'Fisher', 'Human', 'Item', 'Knight', 'Law', 'Location', 'Monk', 'Mutant', 'Politician', 'Power', 'Robot', 'Scientist', 'Ship', 'Spirit', 'Thief', 'Witch']
var cardCombos = []
