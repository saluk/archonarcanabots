...
function embedCode() {
    ...
    var image = '';
    var imageel = $('.cardEntry img');
    if(imageel.length>0){
        var image = [0].getAttribute('src');
    }
    var s = '\
    <div>\
    Using the widget<br>\
